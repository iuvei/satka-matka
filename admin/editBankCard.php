...
<div class="container">
  <form action="/action_page.php">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="firstname" placeholder="Your Actual Name..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="lastname" placeholder="IFSC Code..">
      </div>
    </div>
	 <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="lastname" placeholder="Bank Name..">
      </div>
    </div>
	 <div class="row">
      <div class="col-25">
	 ...
	 <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="lastname" placeholder="State/ Territory..">
      </div>
    </div>
    ...
    <div class="row">
	 ...
	 <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="lastname" placeholder="Mobile Number..">
      </div>
    </div>
	 <div class="row">
      <div class="col-25">
	 ...
	 <div class="row">
      <div class="col-25">
        <label for="lname">UPI Account</label>
      </div>
      <div class="col-75">
        <input type="text" id="lname" name="lastname" placeholder="UPI Account..">
      </div>
    </div>
