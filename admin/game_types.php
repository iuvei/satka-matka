            ...
            <div class="product-status mg-tb-15">
                <div class="main-content">
                    <div class="section__content section__content--p30">
                        <DIV class="container-fluid">
                            <h3 class="service_title" style="text-align: center;">Add Game Types</h3>
                            <div style="">
                                <form action="../controller/insert2.php" class="p-5 bg-white" method="POST" enctype="multipart/form-data">
                                    <div class="row form-group">
                                        ...
                                        <input type="hidden" name="tbname" value="game_types">
                                        <div class="col-md-12">
                            ...
                            <div class="sparkline-list" style="margin-top:15px;">
                                <?php
                                $db->showInTable("game_types", "id,name", array(), "all", $externallinks = "", array(), "name asc");
                                ?>
                            </div>
                        </DIV>
                    </div>
