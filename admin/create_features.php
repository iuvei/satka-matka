            ...
            <div class="product-status mg-tb-15">
                <div class="main-content">
                    <div class="section__content section__content--p30">
                        <DIV class="container-fluid">
                            <h3 class="service_title" style="text-align: center;">Create Features</h3>
                            <div style="">
                                <form action="../controller/insert2.php" class="p-5 bg-white" method="POST" enctype="multipart/form-data">
                                    <div class="row form-group">
                                        <div class="row form-group col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <label class="text-black" for="remark">Remark</label> 
                                                <input type="text" id="remark" name="remark" class="form-control" placeholder="Enter remark if any">
                                            </div>
                                           <br>
                                        ...
                                        <input type="hidden" name="tbname" value="features">
                                        <div class="col-md-2">
                          ...
                          <DIV 
                            ...
                            <h3 class="service_title" style="text-align: center;">List Features</h3>
                            <div style="">
                                <?php
                                $db->showInTable("features","*", array(), "all", $externallinks = "", array(), $sort);
                                ?>
                            </div>
