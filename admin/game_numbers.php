            ...
            <div class="product-status mg-tb-15">
                <div class="main-content">
                    <div class="section__content section__content--p30">
                        <DIV class="container-fluid">
                            <h3 class="service_title" style="text-align: center;">Add Game Numbers</h3>
                            <div>
                                    ...
                                    <div class="row form-group">
                                        <div class="row form-group col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" id="name" name="name" class="form-control" placeholder="Enter Number">
                                            </div>
                                            

                                        <input type="hidden" name="api_key" value="<?php echo $user["api_key"]; ?>">
                                        <input type="hidden" name="tbname" value="game_numbers">
                                        <div class="col-md-12">
                            ...
                            <div class="sparkline-list" style="margin-top:15px;">
                                <?php
                                $db->showInTable("game_numbers", "id,name", array(), "all", $externallinks = "", array(), "name asc");
                                ?>
                            </div>
                        </DIV>
                    </div>
