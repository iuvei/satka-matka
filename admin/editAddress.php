  ...
  <form action="/action_page.php">
    ...
    <div class="row">
	 ...
	 <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="lastname" placeholder="PinCode..">
      </div>
    </div>
	 <div class="row">
      <div class="col-25">
	 ...
	 <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="lastname" placeholder="Town/City..">
      </div>
    </div>
	...
	<div class="row">
      ...
      <div class="col-75">
        <textarea id="subject" name="subject" placeholder="Detail Address.." style="height:200px"></textarea>
      </div>
    </div>
