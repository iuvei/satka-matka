                ...
                <div class="main-content">
                    ...
                    <DIV class="container-fluid">
                            <div style="">
                                ...
                                <?php $users = $db->myProfile("user", "id,name,contact,email,userid,image,about", array("id" => $_SESSION["loginid"])); ?>
                            </div>
                            <h4 class="text-center">Login credential</h4>
                            <?php $db->myProfile("user", "id,email,password", array("id" => $user["id"])); ?>
