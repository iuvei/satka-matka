        ...
        <div class="section__content section__content--p30">
          <DIV class="container-fluid">
            <div class="sparkline-list">
              <h3 class="service_title" style="text-align: center;">Add Suggestion/Complaints</h3>
                ...
                <div class="container">
                  <form action="<?php echo $url; ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="col-75">
                        <input type="text" id="fname" name="type" placeholder="Type..">
                      </div>
                    </div>
                    <!-- <div class="row">
                      <div class="col-25">
                        <label for="lname">Out Id</label>
                      </div>
                      <div class="col-75">
                        <input type="text" id="lname" name="outid" placeholder="Out Id..">
                      </div>
                    </div> -->
                    <div class="row">
                      <div class="col-25">
                      ...
                      <div class="col-75">
                        <input type="text" id="lname" name="whatsapp" placeholder="WhatsApp..">
                      </div>
                    </div>
                    ...
                    <input type="hidden" name="tbname" value="complaints">
